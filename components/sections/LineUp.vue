<template>
	<div class="relative overflow-x-clip">
		<AtomsSectionTitle text="クレイジーさを磨けた" text2="ジャンルのみ開設！"
			class="relative z-10 pt-[18.5vw] md:pt-[95px] pb-[4.5vw] md:pb-[12px]" />
		<NuxtImg src="/img/lineup/lineup-bg.webp" loading="lazy"
			class="absolute w-[92vw] md:w-[460px] h-[80vw] md:h-[400px] left-[-28.68vw] md:left-[-143px] top-[-13.5vw] md:top-[-64px]"
			alt="lineup" />
		<div v-for="(feature, index) in features" :key="index">
			<OrganismsLineFeature :index="index" :titTxt="feature.titTxt" :startColor="feature.startColor"
				...
				:btnTxt="feature.btnTxt" :ringImg="feature.ringImg" :customPadding="feature.customPadding" />
		</div>
	</div>
</template>
		...
		return {
			features: [
				...
				},
				{
					...
					customPadding: "px-[5.7vw] md:px-[30px]",
				},
				{
					titTxt: "茶道",
					startColor: "#99DD77",
