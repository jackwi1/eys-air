<template>
	<div class="relative bg-white rounded-md">
		<div class="p-[2.6vw] md:p-[13px]">
			<span
				class="block text-end font-['Roboto_Condensed'] text-[2.6vw] md:text-[10px] text-[#999999] my-[3vw] md:my-[15px]">2022.11.4
				UPDATE</span>
			<h3 class="text-smsub md:text-sub mt-[3vw] md:mt-[15px] mb-[2vw] md:mb-[10px]">
				代官山スタジオがグランドOPEN
			</h3>
			<p class="text-[2.8vw] md:text-[14px] leading-[5vw] md:leading-[25px] text-[#222222]">
				音楽教室激戦区・代官山にEYSの新たな代官山スタジオをOPEN！高級感のあるカ…
			</p>
		</div>
		<div class="w-full relative">
			<NuxtImg src="/img/news/room.webp" loading="lazy" class="w-full h-[55vw] md:h-[275px]" alt="room" />
			<NuxtImg src="/img/news/room-inside.webp" loading="lazy" class="w-full absolute bottom-0" alt="room" />
		</div>
		<div class="px-[2.6vw] md:px-[13px] pt-[2.6vw] md:pt-[13px] pb-[0.6vw] md:pb-[3px]">
			...
			<div class="relative top-[-2vw] md:top-[-10px]">
				...
				<p
					class="bg-[#F6F6F6] text-[2.6vw] md:text-[13px] p-[2.6vw] md:p-[13px] leading-[3.4vw] md:leading-[17px] rounded-lg text-[#444444]">
